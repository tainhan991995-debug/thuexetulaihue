      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-5 lg:grid-cols-[1fr_1fr] lg:px-8">
        ...
        <div className="relative mx-auto w-full max-w-[720px] lg:ml-auto lg:mr-0">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/30 bg-white/10 p-2 shadow-[0_35px_80px_rgba(0,0,0,.3)] backdrop-blur-sm">
            <picture>
              <source srcSet="/images/tram-nha-minh-fleet.avif" type="image/avif" />
              <source srcSet="/images/tram-nha-minh-fleet.webp" type="image/webp" />
              <img src="/images/tram-nha-minh-fleet.webp" width={1299} height={878} fetchPriority="high" decoding="async" alt={`Đội xe thuê xe tự lái Huế của ${brandName}: VinFast, xe điện và xe xăng`} className="block h-auto w-full rounded-[1.6rem]" />
            </picture>
...
export default function Home() {
  preload("/images/tram-nha-minh-fleet.avif", { as: "image", type: "image/avif", fetchPriority: "high" });
